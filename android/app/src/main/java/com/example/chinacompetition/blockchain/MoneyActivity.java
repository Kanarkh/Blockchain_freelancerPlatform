...
public class MoneyActivity extends AppCompatActivity {
    ...
    Button btn_money_charge; // charge
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG,"money_ID"+ID);
        text_money_mymoney = (TextView) findViewById(R.id.text_money_mymoney);
        btn_money_charge = (Button) findViewById(R.id.btn_money_charge);
        ...
        // move to money charge
        btn_money_charge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
