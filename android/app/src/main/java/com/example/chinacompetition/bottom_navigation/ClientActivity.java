        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_message:
                    Intent intentFitting = new Intent(ClientActivity.this, MessageActivity.class);
                    startActivity(intentFitting);
                    break;
                // 프리랜서화면으로 이동
                case R.id.navigation_freelancer:
                    Intent intentHome = new Intent(ClientActivity.this, FreelancerActivity.class);
                    startActivity(intentHome);
                    break;
                // 내프로필화면으로이동
                case R.id.navigation_profile:
                    Intent intentMyProfile = new Intent(ClientActivity.this, ProfileActivity.class);
                    startActivity(intentMyProfile);
                    break;
                // 장바구니화면으로이동
                case R.id.navigation_category:
                    Intent intentCart = new Intent(ClientActivity.this, CategoryActivity.class);
