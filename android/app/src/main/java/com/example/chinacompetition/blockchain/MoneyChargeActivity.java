...
public class MoneyChargeActivity extends AppCompatActivity {
    ...
    String TAG = "MoneyChargeActivity";
    String ID ;
    EditText edit_money_charge_input ;
    ImageView image_money_charge_back ;
    public String cash;
    public void bt_Deposit(View view) {
        cash = edit_money_charge_input.getText().toString();
        Deposit(ID,cash);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_money_charge_input = (EditText) findViewById(R.id.edit_money_charge_input);
        image_money_charge_back = (ImageView) findViewById(R.id.image_money_charge_back);
        Log.e(TAG,"MoneyCharge"+ID);

        image_money_charge_back.setOnClickListener(new View.OnClickListener() {
            @Override
