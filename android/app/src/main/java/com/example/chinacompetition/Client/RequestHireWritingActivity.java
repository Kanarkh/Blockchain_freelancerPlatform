...
import com.example.chinacompetition.PostJobDir.CalendarActivity;
...
public class RequestHireWritingActivity extends AppCompatActivity {

    private String TAG = "RequestHireWritingActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_hire_writing);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()){
                    try {
                        ...
                        if(result.equals("ok")){
                            Toast.makeText(getApplicationContext(), "고용요청하셨씁니다..", Toast.LENGTH_SHORT).show();
                            Log.i(TAG, "post success");
                            Log.e(TAG, "post success");
                            // Client화면으로 이동
                            Intent intent = new Intent(RequestHireWritingActivity.this, ClientActivity.class);
